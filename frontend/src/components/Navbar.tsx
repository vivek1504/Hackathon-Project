export const Navbar = () => {
  ...
  <a href="" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="https://freesvg.org/img/2011-02-15-Cartoon-carrot.png" className="h-8" alt="Carrot Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Diet.io</span>
  </a>
